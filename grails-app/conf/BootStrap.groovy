...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		Weather weather2 = new Weather(zipCode:30064,temperature:64,iconUrl:"http://openweathermap.org/img/w/10n.png")
		Weather weather3 = new Weather(zipCode:30339,temperature:68,iconUrl:"http://openweathermap.org/img/w/01n.png")
        if (!weather1.save()){
